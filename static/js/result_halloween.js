...
if (result < 9) {
    ...
    document.querySelector('.good').innerHTML = '같이 놀면 재밌는 애<img class="col-12" src="/static/img/testResult_Halloween/1.png" alt="01">할리퀸 룩';
    document.querySelector('.bad').innerHTML = '같이 놀면 재미 없는 애<img class="col-12" src="/static/img/testResult_Halloween/3.png" alt="03">좀비 룩';
}
