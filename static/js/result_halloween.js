if(localStorage.getItem('result_halloween')){
    var result = localStorage.getItem('result_halloween')
   }
...
if (result > 8 && result < 12) {
    ...
    document.querySelector('.good').innerHTML = '잘 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/2.png" alt="02">슈퍼마리오 룩';
    document.querySelector('.bad').innerHTML = '안 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/3.png" alt="03">스폰지밥 룩';
    ...
    document.querySelector('.good').innerHTML = '잘 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/4.png" alt="04">해리포터 룩';
    document.querySelector('.bad').innerHTML = '안 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/3.png" alt="03">스폰지밥 룩';
    ...
    document.querySelector('.good').innerHTML = '잘 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/5.png" alt="05">좀비 룩';
    document.querySelector('.bad').innerHTML = '안 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/1.png" alt="01">할리퀸 룩';
    ...
    document.querySelector('.second').innerHTML = '-근데... 원래 평소에 입던 옷이라며... 후드티에 츄리닝 바지... 안경까지...';
    ...
    document.querySelector('.good').innerHTML = '잘 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/2.png" alt="02">슈퍼마리오 룩';
    document.querySelector('.bad').innerHTML = '안 맞는 애<img class="col-12" src="/static/img/testResult_Halloween/5.png" alt="05">좀비 룩';
}else{
