...
if (result > 7 && result < 11) {
    ...
    document.querySelector('.first').innerHTML = '"I want my freedom." "전 자유를 원해요."';
...
if (result > -11 && result < -6) {
    ...
    document.querySelector('.first').innerHTML = '"Have courage and be kind." "용기를 가지고 항상 친절해야해."';
...
if (result > -4 && result < 1) {
    ...
    document.querySelector('.first').innerHTML = '"Who says that my dreams have to stay my dreams?" "내 꿈이 그저 꿈으로 남아야 한다고 누가 그래?"';
...
if (result > 0 && result < 4) {
    ...
    document.querySelector('.first').innerHTML = '"Do what you like love what you do." "네가 좋아하고 사랑하는 것을 해."';
...
if (result > 3 && result < 6) {
    ...
    document.querySelector('.first').innerHTML = 'You must choose your own path." "자신만의 길을 가야해."';
