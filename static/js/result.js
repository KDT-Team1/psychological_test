...
if (result > 23) {
    ...
    document.querySelector('.name').innerHTML = '호머 심슨(Homer Simpson)';
    ...
    document.querySelector('.mbti').innerHTML = 'ESFP';
    document.querySelector('.good').innerHTML = '잘 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/2.png" alt="05">마지 심슨';
...
if (result > 8 && result < 15) {
    ...
    document.querySelector('.name').innerHTML = '마지 심슨(Marge Simpson)';
    ...
    document.querySelector('.mbti').innerHTML = 'ISFJ';
    document.querySelector('.good').innerHTML = '잘 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/1.png" alt="05">호머 심슨';
    document.querySelector('.bad').innerHTML = '안 맞는 유형<img class="col-12" src="#">없음';
}
...
if (result > 15 && result < 24) {
    ...
    document.querySelector('.mbti').innerHTML = 'ESTP';
    document.querySelector('.good').innerHTML = '잘 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/2.png" alt="05">마지 심슨';
    document.querySelector('.bad').innerHTML = '안 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/1.png" alt="02">호머 심슨';
}

if (result < 9) {
    document.querySelector('.profile').innerHTML = '<img class ="col-12 col-lg-4" src="/static/img/testResult_Simpsons/4.png" alt="04">';
    document.querySelector('.name').innerHTML = '리사 심슨(Lisa Simpson)';
    ...
    document.querySelector('.mbti').innerHTML = 'INFJ';
    document.querySelector('.good').innerHTML = '잘 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/2.png" alt="05">마지 심슨';
    document.querySelector('.bad').innerHTML = '안 맞는 유형<img class="col-12" src="/static/img/testResult_Simpsons/3.png" alt="02">바트 심슨';
}
